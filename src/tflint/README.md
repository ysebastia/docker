...
Command call
```
docker run --rm -t -v "${PWD}":/app -w /app docker.io/ysebastia/tflint:0.53.0 tflint --recursive
```
...
.tflint:
  image: docker.io/ysebastia/tflint:0.53.0
  stage: test
  tags:
    - docker
  script:
