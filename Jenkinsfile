...
pipeline {
    ...
    release_ansible = "ysebastia/ansible:2.15.5"
    release_ansiblelint = "ysebastia/ansible-lint:6.21.1"
    release_checkov = "ysebastia/checkov:2.5.13"
    ...
    release_helm = "ysebastia/helm:3.13.1"
