pipeline {
    agent any
    environment {
    release_ansiblelint = "ysebastia/ansible-lint:6.8.2"
    ...
    release_jshint = "ysebastia/jshint:2.13.5"
    ...
    release_pylint = "ysebastia/pylint:2.15.5"
    release_shellcheck = "ysebastia/shellcheck:0.8.0"
    release_tflint = "ysebastia/tflint:0.42.0"
