...
pipeline {
    ...
    release_ansible = "ysebastia/ansible:2.16.0"
    release_ansiblelint = "ysebastia/ansible-lint:6.22.1"
    release_checkov = "ysebastia/checkov:3.0.24"
    ...
    release_dmarctsreportviewer = "ysebastia/dmarcts-report-viewer:master-php8.1.24-bookworm"
    release_doxygen = "ysebastia/doxygen:1.9.7"
    release_hadolint = "ysebastia/hadolint:2.12.0-1"
    release_helm = "ysebastia/helm:3.13.2"
    release_jest = "ysebastia/jest:29.7.0"
    release_jshint = "ysebastia/jshint:2.13.6"
    release_make = "ysebastia/make:4.4.1-r2"
    release_phpcpd = "ysebastia/phpcpd:6.0.3-php8.1.24"
    release_phpcs = "ysebastia/phpcs:3.7.2-php8.1.24"
    release_phpmd = "ysebastia/phpmd:2.14.1-php8.1.24"
    release_pylint = "ysebastia/pylint:3.0.2"
    release_shellcheck = "ysebastia/shellcheck:0.9.0-r3"
    release_tflint = "ysebastia/tflint:0.49.0"
    release_trivy = "ysebastia/trivy:0.47.0"
    release_wget = "ysebastia/wget:1.21.4-r0-2"
    release_yamllint = "ysebastia/yamllint:1.33.0"
    }
    stages {
        stage ('Checkout') {
            agent any
