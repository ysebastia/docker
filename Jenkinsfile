pipeline {
    agent any
    environment {
    release_ansiblelint = "ysebastia/ansible-lint:6.14.0"
    ...
    release_dmarctsreportviewer = "ysebastia/dmarcts-report-viewer:master-php8.1.16"
    ...
    release_pylint = "ysebastia/pylint:2.16.4"
    ...
    release_yamllint = "ysebastia/yamllint:1.29.0-1"
    }
    stages {
        stage ('Checkout') {
            agent any
