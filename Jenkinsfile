...
pipeline {
    ...
    environment {
        ...
        release_ansible = "ysebastia/ansible:2.19.0"
        release_ansiblebuilder = "ysebastia/ansible-builder:3.1.0"
        release_ansiblelint = "ysebastia/ansible-lint:25.8.2"
        ...
        release_molecule_debian = "ysebastia/molecule:debian-13.0"
            ...
            parallel {
                stage('molecule') {
                    ...
                    steps {
	                    ...
	                    sh 'podman push docker.io/ysebastia/molecule:debian-13.0'
