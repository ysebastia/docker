...
pipeline {
    ...
    release_ansiblelint = "ysebastia/ansible-lint:24.10.0"
    release_checkov = "ysebastia/checkov:3.2.332"
    ...
    release_helm = "ysebastia/helm:3.16.3"
    ...
    release_molecule = "ysebastia/molecule:24.12.0"
    release_molecule_alma = "ysebastia/molecule:alma-9.4"
    release_molecule_debian = "ysebastia/molecule:debian-12.8"
    ...
    release_pylint = "ysebastia/pylint:3.3.1"
