...
pipeline {
    ...
    release_ansible = "ysebastia/ansible:2.18.5"
    release_ansiblebuilder = "ysebastia/ansible-builder:3.1.0"
    release_ansiblelint = "ysebastia/ansible-lint:25.4.0"
    ...
    release_helm = "ysebastia/helm:3.17.3"
