...
pipeline {
    ...
    release_ansible = "ysebastia/ansible:2.16.4"
    release_ansiblelint = "ysebastia/ansible-lint:24.2.1"
    release_checkov = "ysebastia/checkov:3.2.26"
    ...
    release_pylint = "ysebastia/pylint:3.0.4"
