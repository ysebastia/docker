...
pipeline {
    ...
    release_ansible = "ysebastia/ansible:2.17.2"
    release_ansiblelint = "ysebastia/ansible-lint:24.7.0"
    ...
    release_helm = "ysebastia/helm:3.15.2"
    ...
    release_molecule = "ysebastia/molecule:24.7.0"
    release_molecule_alma = "ysebastia/molecule:alma-9.4"
    release_molecule_debian = "ysebastia/molecule:debian-12.6"
    ...
    release_pylint = "ysebastia/pylint:3.2.3"
    release_shellcheck = "ysebastia/shellcheck:0.10.0"
    release_tflint = "ysebastia/tflint:0.51.0"
    release_trivy = "ysebastia/trivy:0.51.1"
