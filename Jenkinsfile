...
pipeline {
    ...
    environment {
        ...
        release_ansible = "ysebastia/ansible:2.19.3"
        release_ansiblebuilder = "ysebastia/ansible-builder:3.1.0"
        release_ansiblelint = "ysebastia/ansible-lint:25.11.0"
        ...
        release_helm = "ysebastia/helm:3.19.0"
        release_jscpd = "ysebastia/jscpd:3.5.10-1"
        release_make = "ysebastia/make:4.4.1-r3"
        release_molecule = "ysebastia/molecule:25.9.0"
        release_molecule_debian = "ysebastia/molecule:debian-13.1"
        release_molecule_podman = "ysebastia/molecule:25.9.0-podman"
        ...
        release_trivy = "ysebastia/trivy:0.64.1"
