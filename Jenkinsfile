pipeline {
    ...
    environment {
	    ...
	    release_dmarctsreportviewer = "ysebastia/dmarcts-report-viewer:master-php8.1.2-2"
	    release_dmarctsreportparser = "ysebastia/dmarcts-report-parser:master-debian11.1-slim-2"
