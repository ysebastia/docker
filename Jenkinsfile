...
pipeline {
    ...
    release_ansible = "ysebastia/ansible:2.17.5"
    release_ansiblelint = "ysebastia/ansible-lint:24.9.2"
    ...
    release_helm = "ysebastia/helm:3.16.2"
    ...
    release_trivy = "ysebastia/trivy:0.55.1"
